    ...
    switch (settings.name) {
      ...
      case Routes.userMainLayout:
        return MaterialPageRoute(
          builder: (_) => BlocProvider<LocationPermissionCubit>(
            create: (context) =>
                LocationPermissionCubit(getIt<GetLocation>())..initialize(),
            child: MainLayOutView(controller: getIt<MainLayoutController>()),
          ),
        );
